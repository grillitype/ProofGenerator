...
class ConfigData(object):
    def __init__(self):
        ...
        # Remove old proof folder if necessary
        self.proof_folder = 'proof'
        if os.path.isdir(self.proof_folder):
            removeDir(self.proof_folder)

        os.mkdir(self.proof_folder)

        # IDML template
        self.idml_template = 'template_proof.idml'
        ...
        self.id_fonts_folderpath = os.path.join(self.proof_folder, 'Document fonts')
...
class CreateInDesignproof(object):
    def __init__(self, path_list):
        ...
        # Save prooft paths for further use at the end
        self.paths = []
        ...
        for font_path in self.fontpath_list:
            ...
            proof_path = os.path.join(self.c.proof_folder, temp_idml)
            os.rename(temp_zip, proof_path)

            # Add IDML file to proof paths
            self.paths.append(proof_path)
...
if __name__ == '__main__':
    ...
    if len(input_paths) > 0:
        proof = CreateInDesignproof(input_paths)
